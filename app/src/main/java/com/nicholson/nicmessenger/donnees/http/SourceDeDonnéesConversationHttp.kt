...
class SourceDeDonnéesConversationHttp( val urlApi : String ) : ISourceDeDonnéesConversation {
    override suspend fun obtenirConversation( idUtilisateur: Long ): List<Conversation> {
        val urlRequête = "$urlApi/conversations/${idUtilisateur}"
    ...
    override suspend fun obtenirMessagesDeConversation( id: Long ): List<Message> {
        val urlRequête = "$urlApi/conversations/messages/${id}"
